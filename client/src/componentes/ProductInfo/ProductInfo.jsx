      ...
      <section className="container general-product-info">
        <div className="row">
          <aside className="col-2 text-center mt-3">
           ...
           <img src={productoStore.images && productoStore.images[0]['i1']} onClick={()=>cambiarImagen('i1')}/>
          {productoStore.images && productoStore.images[0]['i2'] && <img src={productoStore.images[0]['i2']} onClick={()=>cambiarImagen('i2')}/>}
          {productoStore.images && productoStore.images[0]['i3'] && <img src={productoStore.images[0]['i3']} onClick={()=>cambiarImagen('i3')}/>}   
        
          </aside>
          <main className="col-6  text-center">
               <img src={productoStore.images &&productoStore.images[0]['i1']} id='img-actual'/>   
          </main>
